...
class SimpleDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, split):
        self.split = split
        self.n_samples = 4096 if self.split == 'train' else 1024
        self.data, self.class_data = generate_toy_data(self.n_samples)
    ...
    def __getitem__(self, idx):
        ...
        return data, self.class_data[idx]
...
class SimpleModel(torch.nn.Module):
    def __init__(self):
        ...
        self.classification = torch.nn.Linear(16, 2)
